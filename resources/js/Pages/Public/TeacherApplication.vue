                                    ...
                                    <div class="space-y-3">
                                        ...
                                        <label class="flex items-center">
                                            <input
                                                type="checkbox"
                                                v-model="
                                                    formData.hasBackupInternet
                                                "
                                                class="mr-3"
                                            />
                                            <span
                                                >I have backup internet
                                                connection</span
                                            >
                                        </label>
                                        <label class="flex items-center">
                                            <input
                                                type="checkbox"
                                                v-model="
                                                    formData.hasBackupPower
                                                "
                                                class="mr-3"
                                            />
                                            <span>
                                                I have backup power supply
                                                (UPS/power station)
                                            </span>
                                        </label>
                                    </div>
                            ...
                            <div class="space-y-6">
                                <div>
                                    <label
                                        ...
                                        class="block text-sm font-medium text-gray-700 mb-2"
                                    >
                                        Why do you want to teach at Rich
                                        English? *
                                    </label>
                                    <textarea
                                        id="motivation"
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mt-12 text-center" data-aos="fade-up">
                    ...
                    >
                        ...
                        <p class="text-gray-600">
                            You will receive an email within 1-3 days regarding
                            the next step. If you do not receive a response, you
                            may reapply after 7 days.
                        </p>
                    </div>
                </div>
            </div>
...
const handleSubmit = async () => {
    ...
    try {
        ...
        formDataToSend.append(
            "has_webcam",
            formData.value.hasWebcam ? "1" : "0"
        );
        formDataToSend.append(
            "has_headset",
            formData.value.hasHeadset ? "1" : "0"
        );
        formDataToSend.append(
            "has_backup_internet",
