        ...
        >
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <p
                    ...
                    data-aos-delay="100"
                >
                    Celebrating our outstanding teachers who excel in
                    attendance, student satisfaction, and teaching excellence.
                </p>
            </div>
        </section>
                ...
                >
                    <div class="mb-4 sm:mb-0" data-aos="fade-up">
                        ...
                        <p class="text-gray-600">
                            Auto-generated monthly rankings
                        </p>
                    </div>
                    <div
...
const loadLeaderboard = async () => {
    try {
        ...
        leaderboard.value =
            response.data.data || response.data || mockLeaderboard;
    } catch (error) {
