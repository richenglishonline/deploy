        ...
        >
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <p
                    ...
                    data-aos-delay="100"
                >
                    Welcome to Rich English — Where Kindness Leads, English
                    Follows, Growth Lasts.
                </p>
            </div>
        </section>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16" data-aos="fade-up">
                    ...
                    <p class="text-xl text-gray-600 max-w-4xl mx-auto">
                        ...
                        <span class="font-bold text-blue-600">R.I.C.H.</span>
                        for every Korean and Chinese student:
                    </p>
                </div>
                ...
                >
                    <div data-aos="fade-right">
                        ...
                        <p class="text-xl text-gray-600 mb-8">
                            To be a place of growth for both teachers and
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">
                                        Certified educators with years of
                                        experience
                                    </p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">
                                        Students from Korea and China learning
                                        together
                                    </p>
                                </div>
                            </div>
        ...
        <section class="py-20 bg-gray-50">
            <div class="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
                ...
                <p
                    ...
                    data-aos-delay="100"
                >
                    Join our community of learners and experience the R.I.C.H.
